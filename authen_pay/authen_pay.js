...
angular.module('myApp.authen_pay', ['ngRoute'])

    .config(['$routeProvider', function($routeProvider) {
      $routeProvider.when('/MOBILE_SMS_PAY', {
        templateUrl: '/app/authen_pay/authen_pay.html',
        controller: 'AuthenPay'
      });
    }])

    .controller('AuthenPay', function($scope, $http, $rootScope, $location) {
        ...
        $scope.confirmToPay = function () {
            ...
            $http.post('/payment_plugin/mobile/payByMsg.do?dt='+ new Date().getTime(), {
                mobile: $scope.phoneNo,         //手机号
